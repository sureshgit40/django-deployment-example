...
def Financial(request):
    ds=pd.read_csv("/home/suresh/dash_board_cal/d_d/static/rch_flexiable.csv")
    ...
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/finance/finance.png",dpi=100,figsize = (5,5))
    #plt.show()
...
def Keyperformance(request):
    ...
    if os.path.exists("/home/suresh/dash_board_cal/d_d/static/graphs"):
        ...
        shutil.rmtree("/home/suresh/dash_board_cal/d_d/static/graphs")
        os.makedirs("/home/suresh/dash_board_cal/d_d/static/graphs")

        df = pd.read_csv("/home/suresh/dash_board_cal/d_d/static/jk17.csv",index_col=['city'])

        s = pd.Series(df.ix[:,1])
        plt.figure(figsize=(20,10))
        s.plot(kind="bar",title="Total _number_of_pregnant_women_Registered_for_ANC" )
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/graphs/jk1.png",dpi=100,figsize = (5,5))


        s = pd.Series(df.ix[:,2])
        plt.figure(figsize=(20,10))
        s.plot(kind="bar",title="Number of Pregnant women registered within first trimester")
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/graphs/jk2.png",dpi=100,figsize = (5,5))

        s = pd.Series(df.ix[:,3])
        plt.figure(figsize=(20,10))
        s.plot(kind="bar",title="% 1st Trimester registration to Total ANC Registrations")
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/graphs/jk3.png",dpi=100,figsize = (5,5))


        s = pd.Series(df.ix[:,1])
        plt.figure(figsize=(20,10))
        s.plot(kind="bar",title='Number of pregnant women received 4 or more ANC check ups')
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/graphs/jk4.png",dpi=100,figsize = (5,5))


        s = pd.Series(df.ix[:,1])
        plt.figure(figsize=(20,10))
        s.plot(kind="bar",title="TT2 given to Pregnant women (numbers)")
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/graphs/jk5.png",dpi=100,figsize = (5,5))


        s = pd.Series(df.ix[:,1])
        plt.figure(figsize=(20,10))
        s.plot(kind="bar",title="TT Booster given to Pregnant women (numbers)")
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/graphs/jk6.png",dpi=100,figsize = (5,5))

        s = pd.Series(df.ix[:,1])
        plt.figure(figsize=(20,10))
        s.plot(kind="bar",title="% Pregnant Woman received 4 ANC check ups to Total ANC Registrations")
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/graphs/jk7.png",dpi=100,figsize = (5,5))


        s = pd.Series(df.ix[:,1])
        plt.figure(figsize=(20,10))
        s.plot(kind="bar",title="% Pregnant women received TT2+ TT Booster to Total ANC Registration")
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/graphs/jk8.png",dpi=100,figsize = (5,5))


        s = pd.Series(df.ix[:,1])
        plt.figure(figsize=(20,10))
        s.plot(kind="bar",title="Number of Pregnant women given 180 IFA tablets")
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/graphs/jk9.png",dpi=100,figsize = (5,5))
...
def Family_Health(request):
    ...
    if os.path.exists("/home/suresh/dash_board_cal/d_d/static/family_health"):
        #os.rmdir("/home/nitesh/Desktop/dash_board/d_d/static/my")
        #shutil.rmtree("/home/nitesh/Desktop/dash_board/d_d/static/my", ignore_errors=False, onerror=None)
        shutil.rmtree("/home/suresh/dash_board_cal/d_d/static/family_health")
        os.makedirs("/home/suresh/dash_board_cal/d_d/static/family_health")

        df2=pd.read_csv("/home/suresh/dash_board_cal/d_d/static/jk18_new.csv")
        df1=pd.read_csv("/home/suresh/dash_board_cal/d_d/static/jk17_new.csv")
        ...
        fig.tight_layout()
        plt.grid()
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/family_health/family_health1.png")
        ...
        fig.tight_layout()
        plt.grid()
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/family_health/family_health2.png")
        ...
        fig.tight_layout()
        plt.grid()
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/family_health/family_health3.png")
        ...
        fig.tight_layout()
        plt.grid()
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/family_health/family_health4.png")
        ...
        plt.grid()
        fig.tight_layout()
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/family_health/family_health5.png")
...
def Pichart(request):
    ...
    if os.path.exists("/home/suresh/dash_board_cal/d_d/static/pichart"):
        #os.rmdir("/home/nitesh/Desktop/dash_board/d_d/static/my")
        #shutil.rmtree("/home/nitesh/Desktop/dash_board/d_d/static/my", ignore_errors=False, onerror=None)
        shutil.rmtree("/home/suresh/dash_board_cal/d_d/static/pichart")
        os.makedirs("/home/suresh/dash_board_cal/d_d/static/pichart")

        piadf=pd.read_csv("/home/suresh/dash_board_cal/d_d/static/pia.csv",index_col="programme")
        #print(piadf)
        y=list(piadf)
        x=piadf.iloc[0]
        ...
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/pichart/Financial1")
        ...
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/pichart/Financial2")
        ...
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/pichart/Financial3")
        ...
        ax.grid()
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/pichart/Financial4")
        #plt.show()
        ...
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/pichart/Financial5")
        ...
        plt.savefig("/home/suresh/dash_board_cal/d_d/static/pichart/Financial6")
...
def Analysis(request):
    df=pd.read_csv("/home/suresh/dash_board_cal/d_d/static/jk18.csv")
    df1=pd.read_csv("/home/suresh/dash_board_cal/d_d/static/jk17.csv")
    ...
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/3d/jk12.png",dpi = 350)
    ...
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/3d/jk13.png",dpi = 350)
    ...
    p2 = ax.bar(x, z, width, color='blue')
    ax.set_title('% 1st Trimester registration to Total ANC Registrations')
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/3d/jk14.png",dpi = 350)
    ...
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/3d/jk15.png",dpi = 350)
    ...
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/3d/jk16.png",dpi = 350)
    ...
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/3d/jk17.png",dpi = 350)
    ...
    p2 = ax.bar(x, z, width, color='blue')
    ax.set_title('Pregnant Woman received 4 ANC check ups to Total ANC Registrations"')
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/3d/jk18.png",dpi = 350)
    ...
    p2 = ax.bar(x, z, width, color='blue')
    ax.set_title('Number of Pregnant women registered within first trimester')
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/3d/jk19.png",dpi = 350)
    ...
    p2 = ax.bar(x, z, width, color='blue')
    ax.set_title('% Pregnant women received TT2+ TT Booster to Total ANC Registration')
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/3d/jk20.png",dpi = 350)
    ...
    plt.savefig("/home/suresh/dash_board_cal/d_d/static/3d/jk21.png",dpi = 350)
